...
@allure.feature('接口 - 所有物料的第一页 - /softwaresitemap/list_kind_material_id')
class TestFile:

    def setup_class(self):
        self.url = "/softwaresitemap/list_kind_material_id"
    ...
    # 正常参数,material_type=1
    @allure.story('正常参数,material_type=1')
    def test01(self, case_config):
        ...
        try:
            ...
            assert 0 < len(response.json()['material_id_list'])
...
# 正常参数,material_type为空
    @allure.story('正常参数,material_type为空')
...
# 正常参数,material_type=2
    @allure.story('正常参数,material_type=2')
