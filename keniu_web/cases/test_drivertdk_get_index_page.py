...
@allure.feature('接口 - 驱动站首页 - /drivertdk/get_index_page')
class TestFile:

    def setup_class(self):
        self.url = "/drivertdk/get_index_page"
    ...
    def test01(self, case_config):
        ...
        try:
            ...
            assert '驱动下载' in response.json()['tdk']['title']
            assert '全部' in response.json(
            )['multiple_filter']['custom_category_list'][0]['name']
