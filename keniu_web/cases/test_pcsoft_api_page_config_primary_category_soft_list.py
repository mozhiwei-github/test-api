...
@allure.feature('接口 - 一级分类-软件列表 - /pcsoft/api/page/config/primary_category/soft/list')
class TestFile:

    def setup_class(self):
        self.url = "/pcsoft/api/page/config/primary_category/soft/list"
    ...
    @allure.story('正常参数j,primary_category=1')
    ...
    # primary_category=0
    @allure.story('primary_category=0')
