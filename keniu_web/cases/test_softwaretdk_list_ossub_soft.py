...
@allure.feature('接口 - 系统子版本列表页 - /softwaretdk/list_ossub_soft')
class TestFile:

    def setup_class(self):
        self.url = "/softwaretdk/list_ossub_soft"
        self.headers = {'Content-Type': 'application/json'}
        self.payload = json.dumps({
            "os_sub": 0,#系统子版本, 传 0 或 不填表示 all
            "page": 1,
            "page_size": 10,
            "common": {
                "app_id": "109",
