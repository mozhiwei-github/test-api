...
@allure.feature('接口 - 首页左侧功能分类列表页 - /softwarecategory/list_primary_category_soft')
class TestFile:

    def setup_class(self):
        self.url = "/softwarecategory/list_primary_category_soft"
    ...
    # 正常参数,primary_category=0
    @allure.story('正常参数,primary_category=0')
    def test01(self, case_config):
        ...
        try:
            ...
            assert '可牛软件下载' in response.json()['tdk']['title']
            assert '全部' == response.json(
            )['primary_tag_category_list'][0]['name']
...
# 正常参数,primary_category=""
    @allure.story('正常参数,primary_category=""')
...
# 正常参数,primary_category=100
    @allure.story('正常参数,primary_category=100')
