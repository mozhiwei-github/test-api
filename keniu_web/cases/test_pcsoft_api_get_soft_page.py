...
@allure.feature('接口 - 软件落地页 - /pcsoft/api/get_soft_page')
class TestFile:

    def setup_class(self):
        self.url = "/pcsoft/api/get_soft_page"
    ...
    # 正常参数
    @allure.story('正常参数,soft_id=70005960')
    def test01(self, case_config):
        ...
        try:
            ...
            assert 70005960 == response.json()['soft_id']
            assert "钉钉" == response.json()['soft_name']
