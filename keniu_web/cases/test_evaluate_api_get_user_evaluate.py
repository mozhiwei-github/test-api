...
@allure.feature('接口 - 获取用户评分(需要登录) - /evaluate/api/get_user_evaluate')
class TestFile:

    def setup_class(self):
        self.url = "/evaluate/api/get_user_evaluate"
        self.headers = {'Content-Type': 'application/json'}
        self.payload = json.dumps({
            "soft_id": 70005042,
            "uuid": "6fd21f4b13427bf0c6ee3281db4aff3e",
            "finger": "36a23819cb1b155170d204bb56bf7a5a",
            "common": {
                "app_id": "109",
                "tid1": 0,
                "tid2": 0,
    ...
    # 正常参数
    @allure.story('正常参数,soft_id=70005042')
    ...
    def test03(self, case_config):
        ...
        try:
            assert 200 == response.status_code
            assert 4004001 == response.json()['resp_common']['ret']
            assert 'request params error' == response.json()[
                'resp_common']['msg']
        except Exception as e:
            logger.exception(e)
            raise Exception("接口返回不符合预期")
    ...
    def test05(self, case_config):
        ...
        payload = json.dumps({
            ...
            "score": "",
            "soft_id": 70005042,
            "uuid": "0JuubmLn9OSabB4ibgo1z2D0Yaq1oRo4",
            "finger": "PAAtiFqjpKNqVh635CsxdxpKsIQ8qhqo",
            "common": {
                "app_id": "109",
                "tid1": 0,
                "tid2": 0,
...
# 正常参数,soft_id为不存在软件
    @allure.story('正常参数,soft_id为不存在软件')
