...
@allure.feature('接口 - 排行榜-更多-软件列表 - /pcsoft/api/page/config/week-rank/soft/list')
class TestFile:

    def setup_class(self):
        self.url = "/pcsoft/api/page/config/week-rank/soft/list"
