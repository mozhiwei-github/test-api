...
@allure.feature('接口 -标签列表页 - /softwarelabel/list_label_soft')
class TestFile:

    def setup_class(self):
        self.url = "/softwarelabel/list_label_soft"
