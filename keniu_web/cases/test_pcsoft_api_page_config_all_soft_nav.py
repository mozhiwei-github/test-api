...
@allure.feature('接口 - 首页-根据一级导航获取二级标签导航 - /pcsoft/api/page/config/all_soft/nav')
class TestFile:

    def setup_class(self):
        self.url = "/pcsoft/api/page/config/all_soft/nav"
    ...
    def test01(self,case_config):
        ...
        try:
            ...
            assert 5002001 == response.json()['resp_common']['ret']
            assert 'MaterialType err' == response.json()['resp_common']['msg']
