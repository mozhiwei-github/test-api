...
@allure.feature('接口 - 二级分类软件列表页 - /softwaretdk/list_secondary_category_soft')
class TestFile:

    def setup_class(self):
        self.url = "/softwaretdk/list_secondary_category_soft"
...
# 正常参数,secondary_category=2
    @allure.story('正常参数,secondary_category=2')
...
# 正常参数,secondary_category=10
    @allure.story('正常参数,secondary_category=10')
