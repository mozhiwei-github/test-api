...
@allure.feature('接口 - 一级级功能分类列表页 - /softwarecategory/list_primary_tag_category_soft')
class TestFile:

    def setup_class(self):
        self.url = "/softwarecategory/list_primary_tag_category_soft"
        self.headers = {'Content-Type': 'application/json'}
        self.payload = json.dumps({
            "primary_tag_category_id": 45,
            "page": 1,
            "page_size": 10,
            "common": {
                "app_id": "109",
    ...
    # 正常参数,primary_tag_category_id=45
    @allure.story('正常参数,primary_tag_category_id=45')
...
# 正常参数,primary_tag_category_id=""
    @allure.story('正常参数,primary_tag_category_id=""')
    def test06(self, case_config):
        host = case_config['params']['server_host']
        payload = json.dumps({
            "primary_tag_category_id": "",
            "size": 10,
            "page": 1,
            "page_size": 10,
            "common": {
...
# 正常参数,primary_tag_category_id=0
    @allure.story('正常参数,primary_tag_category_id=0')
    def test07(self, case_config):
        host = case_config['params']['server_host']
        payload = json.dumps({
            "primary_tag_category_id": 0,
            "page": 1,
            "page_size": 10,
            "common": {
                "app_id": "109",
