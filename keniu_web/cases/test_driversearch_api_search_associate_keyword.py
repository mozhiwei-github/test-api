...
@allure.feature('接口 - 驱动搜索联想词 - /driversearch/api/search_associate_keyword')
class TestFile:

    def setup_class(self):
        self.url = "/driversearch/api/search_associate_keyword"
    ...
    def test01(self, case_config):
        ...
        try:
            ...
            assert 0 < len(response.json()['items'][0]['exe_file_name'])
