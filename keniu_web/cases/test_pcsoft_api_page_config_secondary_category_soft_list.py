...
@allure.feature('接口 - 二级分类列表 - /pcsoft/api/page/config/secondary_category_soft/list')
class TestFile:

    def setup_class(self):
        self.url = "/pcsoft/api/page/config/secondary_category_soft/list"
    ...
    # 正常参数,secondary_category=1
    @allure.story('正常参数,secondary_category=1')
    ...
    # 正常参数，secondary_category=0
    @allure.story('正常参数，secondary_category=0')
    ...
    # 正常参数，secondary_category=""
    @allure.story('正常参数，secondary_category为空')
    ...
    # 正常参数，secondary_category=999
    @allure.story('正常参数，secondary_category=999')
    def test08(self,case_config):
        host = case_config['params']['server_host']
        payload = json.dumps({
            "secondary_category":999,
            "page": 1,
            "page_size": 50,
            "common": {
                "uid": "",
