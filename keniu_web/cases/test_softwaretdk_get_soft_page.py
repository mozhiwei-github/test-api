...
@allure.feature('接口 - 软件落地页 - /softwaretdk/get_soft_page')
class TestFile:

    def setup_class(self):
        self.url = "/softwaretdk/get_soft_page"
    ...
    # 正常参数
    @allure.story('正常参数,keyword=70005042')
    def test01(self,case_config):
        ...
        try:
            ...
            assert 0 < len(response.json()['tdk'])
            assert 70005042 == response.json()['soft_id']
            assert "微信" == response.json()['soft_name']
